...
// stdio/printk.c if using vga
// static bool print(const char * data, size_t length){
//     const unsigned char* bytes = (const unsigned char*)data;
//     for(size_t i = 0; i < length; i++)
//         if(putuchar(bytes[i]) == EOF)
//             return false;
     
//     return true;
// }

// print - stub (while using term_write)
...
//         if(*format == 'c'){
//             format++;
//             char c = (char) va_arg(parameters, int /* char promots to int*/);
//             if(!maxrem){
//                 // TODO: Set errno to EOVERFLOW
//                 return -1;
//             }
